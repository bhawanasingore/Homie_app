...
public abstract class NetworkEvent extends BaseMessageEvent {
    ...
    public static Builder builder(Type type, long messageId) {
        return new AutoValue_NetworkEvent.Builder().setType((Type) Utils.checkNotNull(type, "type")).setMessageId(messageId).setUncompressedMessageSize(0).setCompressedMessageSize(0);
    }
