...
final class JndiResourceResolverFactory implements DnsNameResolver.ResourceResolverFactory {
    ...
    static final class JndiResourceResolver implements DnsNameResolver.ResourceResolver {
        ...
        public java.util.List<io.grpc.EquivalentAddressGroup> resolveSrv(io.grpc.internal.DnsNameResolver.AddressResolver r19, java.lang.String r20) throws java.lang.Exception {
            /*
                r18 = this;
                r1 = r20
            ...
            L_0x00a5:
                ...
                goto L_0x00a5
            L_0x00c4:
                io.grpc.Attributes$Builder r1 = io.grpc.Attributes.newBuilder()     // Catch:{ UnknownHostException -> 0x00fd, RuntimeException -> 0x00fb }
                io.grpc.Attributes$Key<java.lang.String> r2 = io.grpc.internal.GrpcAttributes.ATTR_LB_ADDR_AUTHORITY     // Catch:{ UnknownHostException -> 0x00fd, RuntimeException -> 0x00fb }
                ...
                r2.<init>((java.util.List<java.net.SocketAddress>) r3, (io.grpc.Attributes) r1)     // Catch:{ UnknownHostException -> 0x00fd, RuntimeException -> 0x00fb }
            ...
            L_0x0151:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.internal.JndiResourceResolverFactory.JndiResourceResolver.resolveSrv(io.grpc.internal.DnsNameResolver$AddressResolver, java.lang.String):java.util.List");
        }
