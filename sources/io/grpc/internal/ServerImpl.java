...
public final class ServerImpl extends Server implements InternalInstrumented<InternalChannelz.ServerStats> {
    ...
    private final class ServerTransportListenerImpl implements ServerTransportListener {
        ...
        public void streamCreated(ServerStream stream, String methodName, Metadata headers) {
            ...
            Context.CancellableContext context = createContext(serverStream, metadata, statsTraceCtx);
            ...
            JumpToApplicationThreadServerStreamListener jumpListener = new JumpToApplicationThreadServerStreamListener(wrappedExecutor, ServerImpl.this.executor, serverStream, context);
            serverStream.setListener(jumpListener);
            wrappedExecutor.execute(new ContextRunnable(context, methodName, stream, headers, statsTraceCtx, jumpListener) {
                ...
                public void runInContext() {
                    ...
                    try {
                        ...
                        this.val$jumpListener.setListener(ServerTransportListenerImpl.this.startCall(this.val$stream, this.val$methodName, method, this.val$headers, this.val$context, this.val$statsTraceCtx));
        ...
        private Context.CancellableContext createContext(final ServerStream stream, Metadata headers, StatsTraceContext statsTraceCtx) {
            ...
            Context.CancellableContext context = baseContext.withDeadlineAfter(timeoutNanos.longValue(), TimeUnit.NANOSECONDS, this.transport.getScheduledExecutorService());
        ...
        /* access modifiers changed from: private */
        public <ReqT, RespT> ServerStreamListener startCall(ServerStream stream, String fullMethodName, ServerMethodDefinition<ReqT, RespT> methodDef, Metadata headers, Context.CancellableContext context, StatsTraceContext statsTraceCtx) {
            ...
            return startWrappedCall(fullMethodName, ServerImpl.this.binlog == null ? interceptedDef : ServerImpl.this.binlog.wrapMethodDefinition(interceptedDef), stream, headers, context);
        }
        ...
        private <WReqT, WRespT> ServerStreamListener startWrappedCall(String fullMethodName, ServerMethodDefinition<WReqT, WRespT> methodDef, ServerStream stream, Metadata headers, Context.CancellableContext context) {
            ServerCallImpl serverCallImpl = new ServerCallImpl(stream, methodDef.getMethodDescriptor(), headers, context, ServerImpl.this.decompressorRegistry, ServerImpl.this.compressorRegistry, ServerImpl.this.serverCallTracer);
    ...
    static final class JumpToApplicationThreadServerStreamListener implements ServerStreamListener {
        ...
        public JumpToApplicationThreadServerStreamListener(Executor executor, Executor cancelExecutor2, ServerStream stream2, Context.CancellableContext context2) {
