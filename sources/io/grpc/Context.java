...
public class Context {
    ...
    public CancellableContext withDeadline(Deadline deadline, ScheduledExecutorService scheduler) {
        ...
        return new CancellableContext(deadline, scheduler);
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:15:0x0025, code lost:
        if ((r0.get(r1).listener instanceof io.grpc.Context.ParentListener) != false) goto L_0x0030;
     */
    ...
    public static final class CancellableContext extends Context implements Closeable {
        ...
        private CancellableContext(Context parent, Deadline deadline2, ScheduledExecutorService scheduler) {
            super(parent.keyValueEntries);
            Deadline parentDeadline = parent.getDeadline();
            if (parentDeadline != null && parentDeadline.compareTo(deadline2) <= 0) {
                deadline2 = parentDeadline;
            } else if (!deadline2.isExpired()) {
