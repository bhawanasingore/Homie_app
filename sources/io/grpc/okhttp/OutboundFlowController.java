...
class OutboundFlowController {
    ...
    OutboundFlowController(OkHttpClientTransport transport2, FrameWriter frameWriter2, int initialWindowSize2) {
        ...
        this.connectionState = new OutboundFlowState(0, initialWindowSize2);
    }
    ...
    private final class OutboundFlowState {
        ...
        OutboundFlowState(OutboundFlowController outboundFlowController, OkHttpClientStream stream2, int initialWindowSize) {
            this(stream2.id(), initialWindowSize);
            this.stream = stream2;
        }
