...
class OkHttpClientStream extends AbstractClientStream {
    ...
    OkHttpClientStream(MethodDescriptor<?, ?> method2, Metadata headers, ExceptionHandlingFrameWriter frameWriter, OkHttpClientTransport transport, OutboundFlowController outboundFlow, Object lock, int maxMessageSize, int initialWindowSize, String authority2, String userAgent2, StatsTraceContext statsTraceCtx2, TransportTracer transportTracer, CallOptions callOptions) {
        super(new OkHttpWritableBufferAllocator(), statsTraceCtx2, transportTracer, headers, callOptions, method2.isSafe());
        ...
        this.state = new TransportState(maxMessageSize, statsTraceCtx2, lock, frameWriter, outboundFlow, transport, initialWindowSize);
    }
    ...
    class TransportState extends Http2ClientStreamTransportState {
        ...
        public TransportState(int maxMessageSize, StatsTraceContext statsTraceCtx, Object lock2, ExceptionHandlingFrameWriter frameWriter2, OutboundFlowController outboundFlow2, OkHttpClientTransport transport2, int initialWindowSize2) {
        ...
        public void start(int streamId) {
            ...
            int unused = OkHttpClientStream.this.id = streamId;
        ...
        public void bytesRead(int processedBytes) {
            ...
            if (((float) i) <= ((float) i2) * 0.5f) {
                ...
                this.frameWriter.windowUpdate(OkHttpClientStream.this.id(), (long) delta);
            }
        }
