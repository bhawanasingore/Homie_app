...
public class Platform {
    ...
    private static Platform findPlatform() {
        ...
        if (androidOrAppEngineProvider != null) {
            ...
            } else if (androidOrAppEngineProvider.getName().equals(ProviderInstaller.PROVIDER_NAME) || androidOrAppEngineProvider.getName().equals("Conscrypt") || androidOrAppEngineProvider.getName().equals("Ssl_Guard")) {
                tlsExtensionType = TlsExtensionType.ALPN_AND_NPN;
