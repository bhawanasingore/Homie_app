            ...
            if (bytesToRecover > 0) {
                ...
                while (true) {
                    ...
                    if (j < this.nextDynamicTableIndex || bytesToRecover <= 0) {
                        ...
                        int i = this.nextDynamicTableIndex;
                ...
                int i2 = this.nextDynamicTableIndex;
                System.arraycopy(headerArr2, i2 + 1, headerArr2, i2 + 1 + entriesToEvict, this.dynamicTableHeaderCount);
                this.nextDynamicTableIndex += entriesToEvict;
            }
