...
class OkHttpClientTransport implements ConnectionClientTransport, ExceptionHandlingFrameWriter.TransportExceptionHandler {
    ...
    static /* synthetic */ int access$2312(OkHttpClientTransport x0, int x1) {
    ...
    public OkHttpClientStream newStream(MethodDescriptor<?, ?> method, Metadata headers, CallOptions callOptions) {
        ...
        StatsTraceContext statsTraceCtx = StatsTraceContext.newClientContext(callOptions, this.attributes, metadata);
        ...
        synchronized (obj2) {
            try {
                ...
                obj = obj2;
                OkHttpClientStream okHttpClientStream = new OkHttpClientStream(method, headers, exceptionHandlingFrameWriter, this, outboundFlowController, obj3, i, i2, str, str2, statsTraceCtx, this.transportTracer, callOptions);
    ...
    private void startStream(OkHttpClientStream stream) {
        Preconditions.checkState(stream.id() == -1, "StreamId already assigned");
    ...
    public Runnable start(ManagedClientTransport.Listener listener2) {
        ...
        if (isForTest()) {
            synchronized (this.lock) {
                ...
                this.outboundFlow = new OutboundFlowController(this, exceptionHandlingFrameWriter, this.initialWindowSize);
            }
        ...
        synchronized (this.lock) {
            ExceptionHandlingFrameWriter exceptionHandlingFrameWriter2 = new ExceptionHandlingFrameWriter(this, rawFrameWriter);
            this.frameWriter = exceptionHandlingFrameWriter2;
            this.outboundFlow = new OutboundFlowController(this, exceptionHandlingFrameWriter2, this.initialWindowSize);
        }
        ...
        this.serializingExecutor.execute(new Runnable() {
            public void run() {
                ...
                try {
                    ...
                    OkHttpClientTransport okHttpClientTransport = OkHttpClientTransport.this;
                    ClientFrameHandler unused2 = okHttpClientTransport.clientFrameHandler = new ClientFrameHandler(okHttpClientTransport, variant.newReader(source2, true));
                    synchronized (OkHttpClientTransport.this.lock) {
                    ...
                    ClientFrameHandler unused5 = okHttpClientTransport2.clientFrameHandler = new ClientFrameHandler(okHttpClientTransport2, variant.newReader(source, true));
                } catch (Exception e3) {
                    OkHttpClientTransport.this.onException(e3);
                    OkHttpClientTransport okHttpClientTransport3 = OkHttpClientTransport.this;
                    ClientFrameHandler unused6 = okHttpClientTransport3.clientFrameHandler = new ClientFrameHandler(okHttpClientTransport3, variant.newReader(source, true));
                } catch (Throwable th) {
                    OkHttpClientTransport okHttpClientTransport4 = OkHttpClientTransport.this;
                    ClientFrameHandler unused7 = okHttpClientTransport4.clientFrameHandler = new ClientFrameHandler(okHttpClientTransport4, variant.newReader(source, true));
                    throw th;
                }
            }
        });
    ...
    private Request createHttpProxyRequest(InetSocketAddress address2, String proxyUsername, String proxyPassword) {
        ...
        Request.Builder url = new Request.Builder().url(tunnelUrl);
        Request.Builder request = url.header(HttpHeaders.HOST, tunnelUrl.host() + ":" + tunnelUrl.port()).header(HttpHeaders.USER_AGENT, this.userAgent);
    ...
    public void shutdownNow(Status reason) {
        ...
        synchronized (this.lock) {
            ...
            while (it2.hasNext()) {
                OkHttpClientStream stream = (OkHttpClientStream) it2.next();
    ...
    static Status toGrpcStatus(ErrorCode code) {
        ...
        return status2.withDescription("Unknown http2 error code: " + code.httpCode);
    }
    ...
    class ClientFrameHandler implements FrameReader.Handler, Runnable {
        ...
        public void run() {
            ...
            while (this.frameReader.nextFrame(this)) {
                try {
                    ...
                    try {
                        ...
                        OkHttpClientTransport.log.log(Level.INFO, "Exception closing frame reader", ex);
                    }
            ...
            try {
                ...
                OkHttpClientTransport.log.log(Level.INFO, "Exception closing frame reader", ex2);
            }
            OkHttpClientTransport.this.listener.transportTerminated();
            if (GrpcUtil.IS_RESTRICTED_APPENGINE) {
                return;
        ...
        public void data(boolean inFinished, int streamId, BufferedSource in, int length) throws IOException {
            this.logger.logData(OkHttpFrameLogger.Direction.INBOUND, streamId, in.buffer(), length, inFinished);
            ...
            if (stream != null) {
                ...
                okHttpClientTransport.onError(errorCode, "Received data for unknown stream: " + streamId);
                return;
            }
            OkHttpClientTransport.access$2312(OkHttpClientTransport.this, length);
        ...
        public void headers(boolean outFinished, boolean inFinished, int streamId, int associatedStreamId, List<Header> headerBlock, HeadersMode headersMode) {
            ...
            if (unknownStream) {
                OkHttpClientTransport okHttpClientTransport = OkHttpClientTransport.this;
                ErrorCode errorCode = ErrorCode.PROTOCOL_ERROR;
                okHttpClientTransport.onError(errorCode, "Received header for unknown stream: " + streamId);
            }
        }
        ...
        public void rstStream(int streamId, ErrorCode errorCode) {
            ...
            OkHttpClientTransport.this.finishStream(streamId, status, errorCode == ErrorCode.REFUSED_STREAM ? ClientStreamListener.RpcProgress.REFUSED : ClientStreamListener.RpcProgress.PROCESSED, status.getCode() == Status.Code.CANCELLED || status.getCode() == Status.Code.DEADLINE_EXCEEDED, (ErrorCode) null, (Metadata) null);
        }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:21:0x006c, code lost:
            r1 = r10.this$0;
            r2 = io.grpc.okhttp.internal.framed.ErrorCode.PROTOCOL_ERROR;
            io.grpc.okhttp.OkHttpClientTransport.access$2200(r1, r2, "Received window_update for unknown stream: " + r11);
         */
        ...
        public void windowUpdate(int r11, long r12) {
            ...
            L_0x002c:
                ...
                io.grpc.okhttp.OutboundFlowController r2 = r2.outboundFlow     // Catch:{ all -> 0x0085 }
                r3 = 0
                int r4 = (int) r12     // Catch:{ all -> 0x0085 }
                r2.windowUpdate(r3, r4)     // Catch:{ all -> 0x0085 }
            ...
            L_0x0043:
                ...
                int r4 = (int) r12     // Catch:{ all -> 0x0085 }
                r3.windowUpdate(r2, r4)     // Catch:{ all -> 0x0085 }
                goto L_0x0069
            L_0x0060:
                io.grpc.okhttp.OkHttpClientTransport r3 = io.grpc.okhttp.OkHttpClientTransport.this     // Catch:{ all -> 0x0085 }
                boolean r3 = r3.mayHaveCreatedStream(r11)     // Catch:{ all -> 0x0085 }
