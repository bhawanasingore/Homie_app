...
final class InProcessTransport implements ServerTransport, ConnectionClientTransport {
    ...
    public InProcessTransport(String name2, int maxInboundMetadataSize, String authority2, String userAgent2, Attributes eagAttrs) {
        ...
        this.attributes = Attributes.newBuilder().set(GrpcAttributes.ATTR_SECURITY_LEVEL, SecurityLevel.PRIVACY_AND_INTEGRITY).set(GrpcAttributes.ATTR_CLIENT_EAG_ATTRS, eagAttrs).build();
        ...
        private class InProcessServerStream implements ServerStream {
            ...
            public synchronized boolean clientRequested(int r7) {
                ...
                L_0x0015:
                    ...
                    io.grpc.internal.StreamListener$MessageProducer r4 = (io.grpc.internal.StreamListener.MessageProducer) r4     // Catch:{ all -> 0x0079 }
                ...
                L_0x003a:
                    ...
                    io.grpc.inprocess.InProcessTransport$InProcessStream r3 = io.grpc.inprocess.InProcessTransport.InProcessStream.this     // Catch:{ all -> 0x0079 }
            ...
            /* JADX WARNING: Code restructure failed: missing block: B:12:0x0037, code lost:
                io.grpc.inprocess.InProcessTransport.InProcessStream.access$1900(r2.this$1);
             */
            /* JADX WARNING: Code restructure failed: missing block: B:13:0x003c, code lost:
                return;
             */
            /* Code decompiled incorrectly, please refer to instructions dump. */
            private void notifyClientClose(io.grpc.Status r3, io.grpc.Metadata r4) {
                /*
                    r2 = this;
                    io.grpc.Status r0 = io.grpc.inprocess.InProcessTransport.stripCause(r3)
                    monitor-enter(r2)
                ...
                L_0x000b:
                    ...
                    io.grpc.inprocess.InProcessTransport$InProcessStream r1 = io.grpc.inprocess.InProcessTransport.InProcessStream.this     // Catch:{ all -> 0x003d }
        ...
        private class InProcessClientStream implements ClientStream {
            ...
            public synchronized boolean serverRequested(int r6) {
                ...
                L_0x0015:
                    ...
                    io.grpc.internal.StreamListener$MessageProducer r4 = (io.grpc.internal.StreamListener.MessageProducer) r4     // Catch:{ all -> 0x0055 }
