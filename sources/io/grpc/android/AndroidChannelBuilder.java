...
public final class AndroidChannelBuilder extends ForwardingChannelBuilder<AndroidChannelBuilder> {
    ...
    public AndroidChannelBuilder transportExecutor(@Nullable Executor transportExecutor) {
        try {
            OKHTTP_CHANNEL_BUILDER_CLASS.getMethod("transportExecutor", new Class[]{Executor.class}).invoke(this.delegateBuilder, new Object[]{transportExecutor});
            return this;
        } catch (Exception e) {
    ...
    public AndroidChannelBuilder sslSocketFactory(SSLSocketFactory factory) {
        try {
            OKHTTP_CHANNEL_BUILDER_CLASS.getMethod("sslSocketFactory", new Class[]{SSLSocketFactory.class}).invoke(this.delegateBuilder, new Object[]{factory});
            return this;
        } catch (Exception e) {
