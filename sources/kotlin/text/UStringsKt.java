...
public final class UStringsKt {
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        int uradix = UInt.m88constructorimpl(radix);
        long limitBeforeMul = UnsignedKt.m316ulongDivideeb3DHEI(-1, ULong.m157constructorimpl(((long) uradix) & 4294967295L));
        long result = 0;
        int i = start;
        while (i < length) {
            ...
            long limit2 = limit;
            long result2 = ULong.m157constructorimpl(ULong.m157constructorimpl(((long) uradix) & 4294967295L) * result);
            int length2 = length;
            long result3 = ULong.m157constructorimpl(ULong.m157constructorimpl(((long) UInt.m88constructorimpl(digit)) & 4294967295L) + result2);
