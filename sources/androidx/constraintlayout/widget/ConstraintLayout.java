            ...
            while (true) {
                ...
                if (child2 == null) {
                    ...
                    if (child2.getMeasuredWidth() == widget2.getWidth() && child2.getMeasuredHeight() == widget2.getHeight()) {
                        ...
                        int widthSpec2 = View.MeasureSpec.makeMeasureSpec(widget2.getWidth(), Ints.MAX_POWER_OF_TWO);
                        containerWrapWidth = containerWrapWidth2;
                        int heightSpec2 = View.MeasureSpec.makeMeasureSpec(widget2.getHeight(), Ints.MAX_POWER_OF_TWO);
