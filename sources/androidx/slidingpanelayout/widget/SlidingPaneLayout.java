    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (widthMode != 1073741824) {
            if (!isInEditMode()) {
                ...
                widthMode = Ints.MAX_POWER_OF_TWO;
                widthSize = LogSeverity.NOTICE_VALUE;
            }
            ...
            if (!isInEditMode()) {
                ...
                heightSize2 = LogSeverity.NOTICE_VALUE;
            }
        }
        int layoutHeight = 0;
        ...
        while (true) {
            ...
            if (child.getVisibility() == 8) {
                ...
                if (lp.width == -2) {
                    ...
                    childWidthSpec = View.MeasureSpec.makeMeasureSpec(widthAvailable - horizontalMargin, Ints.MAX_POWER_OF_TWO);
                } else {
                    childWidthSpec = View.MeasureSpec.makeMeasureSpec(lp.width, Ints.MAX_POWER_OF_TWO);
                }
                int i4 = horizontalMargin;
                if (lp.height == -2) {
                    childHeightSpec3 = View.MeasureSpec.makeMeasureSpec(maxLayoutHeight2, Integer.MIN_VALUE);
                } else if (lp.height == -1) {
                    childHeightSpec3 = View.MeasureSpec.makeMeasureSpec(maxLayoutHeight2, Ints.MAX_POWER_OF_TWO);
                } else {
                    childHeightSpec3 = View.MeasureSpec.makeMeasureSpec(lp.height, Ints.MAX_POWER_OF_TWO);
                }
                ...
                if (child2.getVisibility() == i) {
                    ...
                    if (child2.getVisibility() == i) {
                        ...
                        if (!canSlide || child2 == this.mSlideableView) {
                            ...
                            if (lp2.weight > 0.0f) {
                                if (lp2.width != 0) {
                                    childHeightSpec = View.MeasureSpec.makeMeasureSpec(child2.getMeasuredHeight(), Ints.MAX_POWER_OF_TWO);
                                    ...
                                    childHeightSpec = View.MeasureSpec.makeMeasureSpec(maxLayoutHeight2, Ints.MAX_POWER_OF_TWO);
                                } else {
                                    childHeightSpec = View.MeasureSpec.makeMeasureSpec(lp2.height, Ints.MAX_POWER_OF_TWO);
                                }
                                if (canSlide) {
                                    int newWidth = widthAvailable - (lp2.leftMargin + lp2.rightMargin);
                                    fixedPanelWidthLimit = fixedPanelWidthLimit2;
                                    maxLayoutHeight = maxLayoutHeight2;
                                    int maxLayoutHeight3 = View.MeasureSpec.makeMeasureSpec(newWidth, Ints.MAX_POWER_OF_TWO);
                                    ...
                                    fixedPanelWidthLimit = fixedPanelWidthLimit2;
                                    maxLayoutHeight = maxLayoutHeight2;
                                    child2.measure(View.MeasureSpec.makeMeasureSpec(measuredWidth2 + ((int) ((lp2.weight * ((float) Math.max(0, widthRemaining))) / weightSum)), Ints.MAX_POWER_OF_TWO), childHeightSpec);
                                }
                            } else {
                                fixedPanelWidthLimit = fixedPanelWidthLimit2;
                                maxLayoutHeight = maxLayoutHeight2;
                            ...
                            if (skippedFirstPass) {
                                ...
                                if (lp2.height == -2) {
                                    ...
                                    i2 = Ints.MAX_POWER_OF_TWO;
                                    childHeightSpec2 = View.MeasureSpec.makeMeasureSpec(maxLayoutHeight2, Ints.MAX_POWER_OF_TWO);
                                } else {
                                    i2 = Ints.MAX_POWER_OF_TWO;
                                    childHeightSpec2 = View.MeasureSpec.makeMeasureSpec(lp2.height, Ints.MAX_POWER_OF_TWO);
                                }
                            } else {
                                childCount = childCount2;
                                i2 = Ints.MAX_POWER_OF_TWO;
                                childHeightSpec2 = View.MeasureSpec.makeMeasureSpec(child2.getMeasuredHeight(), Ints.MAX_POWER_OF_TWO);
                            }
