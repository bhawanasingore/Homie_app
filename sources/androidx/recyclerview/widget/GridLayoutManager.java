    ...
    public void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state, LinearLayoutManager.LayoutState layoutState, LinearLayoutManager.LayoutChunkResult result) {
        ...
        if (flexibleInOtherDir) {
            ...
            for (int i2 = 0; i2 < count; i2++) {
                ...
                measureChild(view3, Ints.MAX_POWER_OF_TWO, true);
        ...
        while (i3 < count) {
            ...
            if (this.mOrientationHelper.getDecoratedMeasurement(view4) != maxSize) {
                ...
                if (this.mOrientation == 1) {
                    ...
                    wSpec = getChildMeasureSpec(totalSpaceInOther, Ints.MAX_POWER_OF_TWO, horizontalInsets, lp.width, false);
                    hSpec = View.MeasureSpec.makeMeasureSpec(maxSize - verticalInsets, Ints.MAX_POWER_OF_TWO);
                    LayoutParams layoutParams = lp;
                } else {
                    remainingSpan = remainingSpan3;
                    wSpec = View.MeasureSpec.makeMeasureSpec(maxSize - horizontalInsets, Ints.MAX_POWER_OF_TWO);
                    LayoutParams layoutParams2 = lp;
                    hSpec = getChildMeasureSpec(totalSpaceInOther, Ints.MAX_POWER_OF_TWO, verticalInsets, lp.height, false);
                }
