    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (widthMode == Integer.MIN_VALUE) {
            ...
            if (!(tvw == null || tvw.type == 0)) {
                ...
                if (w > 0) {
                    widthMeasureSpec = View.MeasureSpec.makeMeasureSpec(Math.min(w - (this.mDecorPadding.left + this.mDecorPadding.right), View.MeasureSpec.getSize(widthMeasureSpec)), Ints.MAX_POWER_OF_TWO);
                    fixedWidth = true;
                }
            }
        }
        if (heightMode == Integer.MIN_VALUE) {
            ...
            if (!(tvh == null || tvh.type == 0)) {
                ...
                if (h > 0) {
                    heightMeasureSpec = View.MeasureSpec.makeMeasureSpec(Math.min(h - (this.mDecorPadding.top + this.mDecorPadding.bottom), View.MeasureSpec.getSize(heightMeasureSpec)), Ints.MAX_POWER_OF_TWO);
                }
            }
        }
        ...
        int widthMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(width, Ints.MAX_POWER_OF_TWO);
        if (!fixedWidth && widthMode == Integer.MIN_VALUE) {
            ...
            if (!(tv == null || tv.type == 0)) {
                ...
                if (width < min) {
                    widthMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(min, Ints.MAX_POWER_OF_TWO);
                    measure = true;
                }
            }
        }
