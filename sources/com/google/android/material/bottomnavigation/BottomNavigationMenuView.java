...
public class BottomNavigationMenuView extends ViewGroup implements MenuView {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int heightSpec = View.MeasureSpec.makeMeasureSpec(this.itemHeight, Ints.MAX_POWER_OF_TWO);
        int i = 8;
        ...
        for (int i4 = 0; i4 < totalCount; i4++) {
            ...
            if (child.getVisibility() != 8) {
                child.measure(View.MeasureSpec.makeMeasureSpec(this.tempChildWidths[i4], Ints.MAX_POWER_OF_TWO), heightSpec);
                child.getLayoutParams().width = child.getMeasuredWidth();
                totalWidth += child.getMeasuredWidth();
            }
        }
        setMeasuredDimension(View.resolveSizeAndState(totalWidth, View.MeasureSpec.makeMeasureSpec(totalWidth, Ints.MAX_POWER_OF_TWO), 0), View.resolveSizeAndState(this.itemHeight, heightSpec, 0));
    }
