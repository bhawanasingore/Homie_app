...
public class TabLayout extends HorizontalScrollView {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mode2 == Integer.MIN_VALUE) {
            heightMeasureSpec = View.MeasureSpec.makeMeasureSpec(Math.min(idealHeight, View.MeasureSpec.getSize(heightMeasureSpec)), Ints.MAX_POWER_OF_TWO);
        } else if (mode2 == 0) {
            heightMeasureSpec = View.MeasureSpec.makeMeasureSpec(idealHeight, Ints.MAX_POWER_OF_TWO);
        }
        ...
        if (getChildCount() == 1) {
            ...
            if (remeasure) {
                child.measure(View.MeasureSpec.makeMeasureSpec(getMeasuredWidth(), Ints.MAX_POWER_OF_TWO), getChildMeasureSpec(heightMeasureSpec, getPaddingTop() + getPaddingBottom(), child.getLayoutParams().height));
            }
        }
    }
