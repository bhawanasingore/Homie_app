...
public class ChipDrawable extends Drawable implements TintAwareDrawable, Drawable.Callback {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:16:0x003c A[Catch:{ IOException | XmlPullParserException -> 0x0044 }] */
    ...
    public static com.google.android.material.chip.ChipDrawable createFromResource(android.content.Context r5, int r6) {
        /*
            android.content.res.Resources r0 = r5.getResources()     // Catch:{ XmlPullParserException -> 0x0046, IOException -> 0x0044 }
            android.content.res.XmlResourceParser r0 = r0.getXml(r6)     // Catch:{ XmlPullParserException -> 0x0046, IOException -> 0x0044 }
        L_0x0008:
            int r1 = r0.next()     // Catch:{ XmlPullParserException -> 0x0046, IOException -> 0x0044 }
            r2 = 2
        ...
        L_0x0012:
            ...
            java.lang.String r2 = r0.getName()     // Catch:{ XmlPullParserException -> 0x0046, IOException -> 0x0044 }
            java.lang.String r3 = "chip"
            boolean r2 = android.text.TextUtils.equals(r2, r3)     // Catch:{ XmlPullParserException -> 0x0046, IOException -> 0x0044 }
            if (r2 == 0) goto L_0x0034
            android.util.AttributeSet r2 = android.util.Xml.asAttributeSet(r0)     // Catch:{ XmlPullParserException -> 0x0046, IOException -> 0x0044 }
            int r3 = r2.getStyleAttribute()     // Catch:{ XmlPullParserException -> 0x0046, IOException -> 0x0044 }
            if (r3 != 0) goto L_0x002d
            int r4 = com.google.android.material.R.style.Widget_MaterialComponents_Chip_Entry     // Catch:{ XmlPullParserException -> 0x0046, IOException -> 0x0044 }
            r3 = r4
        L_0x002d:
            int r4 = com.google.android.material.R.attr.chipStandaloneStyle     // Catch:{ XmlPullParserException -> 0x0046, IOException -> 0x0044 }
            com.google.android.material.chip.ChipDrawable r4 = createFromAttributes(r5, r2, r4, r3)     // Catch:{ XmlPullParserException -> 0x0046, IOException -> 0x0044 }
            return r4
        L_0x0034:
            org.xmlpull.v1.XmlPullParserException r2 = new org.xmlpull.v1.XmlPullParserException     // Catch:{ XmlPullParserException -> 0x0046, IOException -> 0x0044 }
            java.lang.String r3 = "Must have a <chip> start tag"
            r2.<init>(r3)     // Catch:{ XmlPullParserException -> 0x0046, IOException -> 0x0044 }
            throw r2     // Catch:{ XmlPullParserException -> 0x0046, IOException -> 0x0044 }
        L_0x003c:
            org.xmlpull.v1.XmlPullParserException r2 = new org.xmlpull.v1.XmlPullParserException     // Catch:{ XmlPullParserException -> 0x0046, IOException -> 0x0044 }
