...
final class zzfh extends zzdt<Float> implements zzfq<Float>, zzhf, RandomAccess {
    ...
    public final boolean addAll(Collection<? extends Float> collection) {
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(zzfh.zzb, 0, this.zzb, this.zzc, zzfh.zzc);
            this.zzc = i3;
            this.modCount++;
            return true;
        }
    ...
    public final /* synthetic */ zzfq zza(int i) {
        if (i >= this.zzc) {
            return new zzfh(Arrays.copyOf(this.zzb, i), this.zzc);
        }
    ...
    static {
        zzfh zzfh = new zzfh(new float[0], 0);
        zza = zzfh;
        zzfh.h_();
    }
}
