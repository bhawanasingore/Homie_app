...
final class zzen extends zzel {
    ...
    public final void zza(int i) throws zzft {
        if (this.zzj != i) {
            throw zzft.zze();
        }
    }
    ...
    public final String zzj() throws IOException {
        ...
        if (zzv > 0 && zzv <= this.zzf - this.zzh) {
            String str = new String(this.zzd, this.zzh, zzv, zzfk.zza);
            this.zzh += zzv;
            return str;
        } else if (zzv == 0) {
            return "";
    ...
    public final String zzk() throws IOException {
        ...
        if (zzv > 0) {
            ...
            int i2 = this.zzh;
            if (zzv <= i - i2) {
                String zzb = zzij.zzb(this.zzd, i2, zzv);
                this.zzh += zzv;
                return zzb;
            }
        }
    ...
    public final zzdz zzl() throws IOException {
        byte[] bArr;
        int zzv = zzv();
        if (zzv > 0) {
            int i = this.zzf;
            int i2 = this.zzh;
            if (zzv <= i - i2) {
                zzdz zza = zzdz.zza(this.zzd, i2, zzv);
                this.zzh += zzv;
                return zza;
            }
        }
    ...
    private final int zzv() throws java.io.IOException {
        ...
        L_0x006d:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.measurement.zzen.zzv():int");
    }
    ...
    public final int zzc(int i) throws zzft {
        if (i >= 0) {
            int zzu = i + zzu();
            int i2 = this.zzk;
            if (zzu <= i2) {
