...
final class zzet extends zzdt<Double> implements zzfq<Double>, zzhf, RandomAccess {
    ...
    public final boolean equals(Object obj) {
        ...
        zzet zzet = (zzet) obj;
        if (this.zzc != zzet.zzc) {
            return false;
        }
        double[] dArr = zzet.zzb;
    ...
    public final int hashCode() {
        ...
        for (int i2 = 0; i2 < this.zzc; i2++) {
            i = (i * 31) + zzfk.zza(Double.doubleToLongBits(this.zzb[i2]));
        }
        return i;
    }
    ...
    public final boolean addAll(Collection<? extends Double> collection) {
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(zzet.zzb, 0, this.zzb, this.zzc, zzet.zzc);
            this.zzc = i3;
            this.modCount++;
            return true;
        }
    ...
    static {
        zzet zzet = new zzet(new double[0], 0);
        zza = zzet;
        zzet.h_();
    }
}
