...
class zzhn<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    private final int zza;
    /* access modifiers changed from: private */
    public List<zzhs> zzb;
    /* access modifiers changed from: private */
    public Map<K, V> zzc;
    private boolean zzd;
    private volatile zzhu zze;
    /* access modifiers changed from: private */
    public Map<K, V> zzf;
    private volatile zzho zzg;

    static <FieldDescriptorType extends zzfd<FieldDescriptorType>> zzhn<FieldDescriptorType, Object> zza(int i) {
        return new zzhm(i);
    }
    ...
    public final V put(K k, V v) {
        ...
        int i2 = this.zza;
        if (size == i2) {
            zzhs remove = this.zzb.remove(i2 - 1);
            zzg().put((Comparable) remove.getKey(), remove.getValue());
        }
        this.zzb.add(i, new zzhs(this, k, v));
        return null;
    }
    ...
    public final V zzc(int i) {
        ...
        if (!this.zzc.isEmpty()) {
            ...
            this.zzb.add(new zzhs(this, (Map.Entry) it.next()));
            it.remove();
        }
        return value;
    }
    ...
    public Set<Map.Entry<K, V>> entrySet() {
        if (this.zze == null) {
            this.zze = new zzhu(this, (zzhm) null);
        }
        return this.zze;
    }
    ...
    public final Set<Map.Entry<K, V>> zze() {
        if (this.zzg == null) {
            this.zzg = new zzho(this, (zzhm) null);
        }
        return this.zzg;
    }
    ...
    public boolean equals(Object obj) {
        ...
        int zzc2 = zzc();
        if (zzc2 != zzhn.zzc()) {
            return entrySet().equals(zzhn.entrySet());
        }
        for (int i = 0; i < zzc2; i++) {
            if (!zzb(i).equals(zzhn.zzb(i))) {
                return false;
            }
        }
        if (zzc2 != size) {
            return this.zzc.equals(zzhn.zzc);
        }
        return true;
    }
    ...
    /* synthetic */ zzhn(int i, zzhm zzhm) {
        this(i);
    }
}
