...
public abstract class zzes extends zzea {
    private static final Logger zzb = Logger.getLogger(zzes.class.getName());
    /* access modifiers changed from: private */
    public static final boolean zzc = zzig.zza();
    zzeu zza;

    public static zzes zza(byte[] bArr) {
    ...
    public abstract void zza(int i, zzdz zzdz) throws IOException;

    public abstract void zza(int i, zzgt zzgt) throws IOException;

    /* access modifiers changed from: package-private */
    public abstract void zza(int i, zzgt zzgt, zzhi zzhi) throws IOException;
    ...
    public abstract void zza(zzdz zzdz) throws IOException;
    ...
    public abstract void zzb(int i, zzdz zzdz) throws IOException;
    ...
    static class zzb extends zzes {
        ...
        public final void zza(zzdz zzdz) throws IOException {
            zzb(zzdz.zza());
            zzdz.zza((zzea) this);
        }
        ...
        /* access modifiers changed from: package-private */
        public final void zza(int i, zzgt zzgt, zzhi zzhi) throws IOException {
            zza(i, 2);
            zzdq zzdq = (zzdq) zzgt;
            int zzbj = zzdq.zzbj();
            if (zzbj == -1) {
        ...
        public final void zzb(int i, zzdz zzdz) throws IOException {
            zza(1, 3);
            zzc(2, i);
            zza(3, zzdz);
            zza(1, 4);
        ...
        public final void zza(String str) throws IOException {
            ...
            try {
                ...
                if (zzg2 == zzg) {
                    int i2 = i + zzg2;
                    this.zze = i2;
                    int zza = zzij.zza(str, this.zzb, i2, zza());
                    this.zze = i;
                    zzb((zza - i) - zzg2);
                    this.zze = zza;
                    return;
                }
                zzb(zzij.zza((CharSequence) str));
                this.zze = zzij.zza(str, this.zzb, this.zze, zza());
            } catch (zzim e) {
                this.zze = i;
                zza(str, e);
    ...
    public static int zzc(int i, zzdz zzdz) {
        int zze = zze(i);
        int zza2 = zzdz.zza();
        return zze + zzg(zza2) + zza2;
    }

    public static int zza(int i, zzfy zzfy) {
        int zze = zze(i);
        int zzb2 = zzfy.zzb();
        return zze + zzg(zzb2) + zzb2;
    }

    static int zzb(int i, zzgt zzgt, zzhi zzhi) {
        return zze(i) + zza(zzgt, zzhi);
    }

    public static int zzb(int i, zzgt zzgt) {
        return (zze(1) << 1) + zzg(2, i) + zze(3) + zzb(zzgt);
    }

    public static int zzd(int i, zzdz zzdz) {
        return (zze(1) << 1) + zzg(2, i) + zzc(3, zzdz);
    }

    public static int zzb(int i, zzfy zzfy) {
        return (zze(1) << 1) + zzg(2, i) + zza(3, zzfy);
    }
    ...
    public static int zzb(String str) {
        int i;
        try {
            i = zzij.zza((CharSequence) str);
        } catch (zzim e) {
            i = str.getBytes(zzfk.zza).length;
        }
        return zzg(i) + i;
    }

    public static int zza(zzfy zzfy) {
        int zzb2 = zzfy.zzb();
        return zzg(zzb2) + zzb2;
    }

    public static int zzb(zzdz zzdz) {
        int zza2 = zzdz.zza();
    ...
    static int zza(zzgt zzgt, zzhi zzhi) {
        zzdq zzdq = (zzdq) zzgt;
        int zzbj = zzdq.zzbj();
        if (zzbj == -1) {
            zzbj = zzhi.zzb(zzdq);
    ...
    /* access modifiers changed from: package-private */
    public final void zza(String str, zzim zzim) throws IOException {
        zzb.logp(Level.WARNING, "com.google.protobuf.CodedOutputStream", "inefficientWriteStringNoTag", "Converting ill-formed UTF-16. Your Protocol Buffer will not round trip correctly!", zzim);
        byte[] bytes = str.getBytes(zzfk.zza);
        try {
            zzb(bytes.length);
    ...
    @Deprecated
    static int zzc(int i, zzgt zzgt, zzhi zzhi) {
        int zze = zze(i) << 1;
        zzdq zzdq = (zzdq) zzgt;
        int zzbj = zzdq.zzbj();
        if (zzbj == -1) {
    ...
    @Deprecated
    public static int zzc(zzgt zzgt) {
        return zzgt.zzbn();
    }
