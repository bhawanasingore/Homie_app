...
final class zzig {
    ...
    private static final Class<?> zzd = zzdw.zzb();
    ...
    static final class zza extends zzd {
        ...
        public final byte zza(Object obj, long j) {
            if (zzig.zza) {
                return zzig.zzk(obj, j);
            }
            return zzig.zzl(obj, j);
        }
        ...
        public final boolean zzb(Object obj, long j) {
            if (zzig.zza) {
                return zzig.zzm(obj, j);
            }
            return zzig.zzn(obj, j);
        }
    ...
    static Unsafe zzc() {
        try {
            return (Unsafe) AccessController.doPrivileged(new zzii());
        } catch (Throwable th) {
            return null;
        }
    }
    ...
    private static Field zzf() {
        Field zza2;
        if (zzdw.zza() && (zza2 = zza((Class<?>) Buffer.class, "effectiveDirectAddress")) != null) {
            return zza2;
        }
