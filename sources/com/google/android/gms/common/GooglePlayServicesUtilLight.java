...
public class GooglePlayServicesUtilLight {
    ...
    public static boolean isRestrictedUserProfile(Context context) {
        ...
        if (!PlatformVersion.isAtLeastJellyBeanMR2() || (applicationRestrictions = ((UserManager) context.getSystemService(Constants.USER)).getApplicationRestrictions(context.getPackageName())) == null || !"true".equals(applicationRestrictions.getString("restricted_profile"))) {
            return false;
        }
        return true;
    }
