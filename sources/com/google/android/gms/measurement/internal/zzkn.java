...
public final class zzkn extends AbstractSafeParcelable {
    public static final Parcelable.Creator<zzkn> CREATOR = new zzkm();
    ...
    zzkn(zzkp zzkp) {
        this(zzkp.zzc, zzkp.zzd, zzkp.zze, zzkp.zzb);
    }
    ...
    zzkn(int i, String str, long j, Long l, Float f, String str2, String str3, Double d) {
        this.zzg = i;
        this.zza = str;
        this.zzb = j;
        this.zzc = l;
