...
final class zzg {
    ...
    public final void zza(String str) {
        this.zza.zzq().zzd();
        this.zzae |= !zzko.zzc(this.zzc, str);
        this.zzc = str;
    }
    ...
    public final void zzb(String str) {
        ...
        this.zzae |= !zzko.zzc(this.zzd, str);
        this.zzd = str;
    }
    ...
    public final void zzc(String str) {
        ...
        this.zzae |= !zzko.zzc(this.zzs, str);
        this.zzs = str;
    }
    ...
    public final void zzd(String str) {
        ...
        this.zzae |= !zzko.zzc(this.zzw, str);
        this.zzw = str;
    }
    ...
    public final void zze(String str) {
        this.zza.zzq().zzd();
        this.zzae |= !zzko.zzc(this.zze, str);
        this.zze = str;
    }
    ...
    public final void zzf(String str) {
        this.zza.zzq().zzd();
        this.zzae |= !zzko.zzc(this.zzf, str);
        this.zzf = str;
    }
    ...
    public final void zzg(String str) {
        this.zza.zzq().zzd();
        this.zzae |= !zzko.zzc(this.zzj, str);
        this.zzj = str;
    }
    ...
    public final void zzh(String str) {
        this.zza.zzq().zzd();
        this.zzae |= !zzko.zzc(this.zzl, str);
        this.zzl = str;
    }
    ...
    public final void zzv() {
        ...
        long j = this.zzg + 1;
        if (j > 2147483647L) {
            this.zza.zzr().zzi().zza("Bundle index overflow. appId", zzet.zza(this.zzb));
            j = 0;
        }
        this.zzae = true;
        this.zzg = j;
    ...
    public final void zzi(String str) {
        this.zza.zzq().zzd();
        this.zzae |= !zzko.zzc(this.zzad, str);
        this.zzad = str;
    }
    ...
    public final void zza(Boolean bool) {
        this.zza.zzq().zzd();
        this.zzae |= !zzko.zza(this.zzt, bool);
        this.zzt = bool;
    }
