...
public final class NumberParts {
    ...
    public static NumberParts fromLong(long value) {
        ...
        return create(negative2, binaryExponent, ((~(1 << binaryExponent)) & value) << (leadingZeros + 1));
    }
    ...
    public static NumberParts fromDouble(double value) {
        ...
        if (exponent2 < DOUBLE_MIN_EXPONENT) {
            ...
            significand2 = (significand3 & (~(1 << (63 - leadingZeros)))) << (leadingZeros + 1);
    ...
    public double asDouble() {
        ...
        if (representationError != null) {
            ...
            return Double.longBitsToDouble(significand2 | (exponent2 << 52) | (negative() ? Long.MIN_VALUE : 0));
        }
    }
