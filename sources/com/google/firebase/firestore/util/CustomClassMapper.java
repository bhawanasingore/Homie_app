...
public class CustomClassMapper {
                ...
                if (o instanceof Character) {
                    ...
                    if (o instanceof List) {
                        ...
                        for (int i = 0; i < list.size(); i++) {
                            ...
                            result2.add(serialize(obj, path.child("[" + i + "]")));
                        }
                        return result2;
                    }
    ...
    private static <T> T deserializeToClass(Object o, Class<T> clazz, DeserializeContext context) {
        ...
        if (clazz.isArray()) {
            ...
            ErrorPath errorPath = context.errorPath;
            throw deserializeError(errorPath, "Class " + clazz.getName() + " has generic type parameters, please use GenericTypeIndicator instead");
        ...
        if (List.class.isAssignableFrom(rawType)) {
            ...
            if (o instanceof List) {
                ...
                for (int i = 0; i < list.size(); i++) {
                    Object obj = list.get(i);
                    ErrorPath errorPath = context.errorPath;
                    result.add(deserializeToType(obj, genericType, context.newInstanceWithErrorPath(errorPath.child("[" + i + "]"))));
                }
                return result;
            }
            ErrorPath errorPath2 = context.errorPath;
            throw deserializeError(errorPath2, "Expected a List, but got a " + o.getClass());
            ...
            ErrorPath errorPath3 = context.errorPath;
            throw deserializeError(errorPath3, "Only Maps with string keys are supported, but found Map with key type " + keyType);
    ...
    private static <T> T deserializeToEnum(Object object, Class<T> clazz, DeserializeContext context) {
        if (object instanceof String) {
            ...
            try {
                ...
                ErrorPath errorPath = context.errorPath;
                throw deserializeError(errorPath, "Could not find enum value of " + clazz.getName() + " for value \"" + value + "\"");
            }
        } else {
            ErrorPath errorPath2 = context.errorPath;
            throw deserializeError(errorPath2, "Expected a String while deserializing to enum " + clazz + " but got a " + object.getClass());
        }
    }
    ...
    private static Map<String, Object> expectMap(Object object, DeserializeContext context) {
        ...
        ErrorPath errorPath = context.errorPath;
        throw deserializeError(errorPath, "Expected a Map while deserializing, but got a " + object.getClass());
    }
    ...
    private static Integer convertInteger(Object o, DeserializeContext context) {
        ...
        if ((o instanceof Long) || (o instanceof Double)) {
            ...
            ErrorPath errorPath = context.errorPath;
            throw deserializeError(errorPath, "Numeric value out of 32-bit integer range: " + value + ". Did you mean to use a long or double instead of an int?");
        }
        ErrorPath errorPath2 = context.errorPath;
        throw deserializeError(errorPath2, "Failed to convert a value of type " + o.getClass().getName() + " to int");
    }
    ...
    private static Long convertLong(Object o, DeserializeContext context) {
        ...
        if (o instanceof Double) {
            ...
            ErrorPath errorPath = context.errorPath;
            throw deserializeError(errorPath, "Numeric value out of 64-bit long range: " + value + ". Did you mean to use a double instead of a long?");
        }
        ErrorPath errorPath2 = context.errorPath;
        throw deserializeError(errorPath2, "Failed to convert a value of type " + o.getClass().getName() + " to long");
    }
    ...
    private static Double convertDouble(Object o, DeserializeContext context) {
        ...
        if (o instanceof Long) {
            ...
            ErrorPath errorPath = context.errorPath;
            throw deserializeError(errorPath, "Loss of precision while converting number to double: " + o + ". Did you mean to use a 64-bit long instead?");
        } else if (o instanceof Double) {
            return (Double) o;
        } else {
            ErrorPath errorPath2 = context.errorPath;
            throw deserializeError(errorPath2, "Failed to convert a value of type " + o.getClass().getName() + " to double");
        }
    }
    ...
    private static Boolean convertBoolean(Object o, DeserializeContext context) {
        ...
        ErrorPath errorPath = context.errorPath;
        throw deserializeError(errorPath, "Failed to convert value of type " + o.getClass().getName() + " to boolean");
    }
    ...
    private static String convertString(Object o, DeserializeContext context) {
        ...
        ErrorPath errorPath = context.errorPath;
        throw deserializeError(errorPath, "Failed to convert value of type " + o.getClass().getName() + " to String");
    }
    ...
    private static Date convertDate(Object o, DeserializeContext context) {
        ...
        ErrorPath errorPath = context.errorPath;
        throw deserializeError(errorPath, "Failed to convert value of type " + o.getClass().getName() + " to Date");
    }
    ...
    private static Timestamp convertTimestamp(Object o, DeserializeContext context) {
        ...
        ErrorPath errorPath = context.errorPath;
        throw deserializeError(errorPath, "Failed to convert value of type " + o.getClass().getName() + " to Timestamp");
    }
    ...
    private static Blob convertBlob(Object o, DeserializeContext context) {
        ...
        ErrorPath errorPath = context.errorPath;
        throw deserializeError(errorPath, "Failed to convert value of type " + o.getClass().getName() + " to Blob");
    }
    ...
    private static GeoPoint convertGeoPoint(Object o, DeserializeContext context) {
        ...
        ErrorPath errorPath = context.errorPath;
        throw deserializeError(errorPath, "Failed to convert value of type " + o.getClass().getName() + " to GeoPoint");
    }
    ...
    private static DocumentReference convertDocumentReference(Object o, DeserializeContext context) {
        ...
        ErrorPath errorPath = context.errorPath;
        throw deserializeError(errorPath, "Failed to convert value of type " + o.getClass().getName() + " to DocumentReference");
    }
    ...
    private static <T> T convertBean(Object o, Class<T> clazz, DeserializeContext context) {
        ...
        ErrorPath errorPath = context.errorPath;
        throw deserializeError(errorPath, "Can't convert object of type " + o.getClass().getName() + " to type " + clazz.getName());
    }
