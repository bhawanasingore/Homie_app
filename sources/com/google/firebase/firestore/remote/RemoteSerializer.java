...
public final class RemoteSerializer {
    ...
    public Mutation decodeMutation(Write mutation) {
        ...
        int i = AnonymousClass1.$SwitchMap$com$google$firestore$v1$Write$OperationCase[mutation.getOperationCase().ordinal()];
        boolean z = true;
        if (i != 1) {
            if (i == 2) {
    ...
    private String encodeLabel(QueryPurpose purpose) {
        int i = AnonymousClass1.$SwitchMap$com$google$firebase$firestore$local$QueryPurpose[purpose.ordinal()];
        if (i == 1) {
            return null;
        }
        if (i == 2) {
    ...
    public com.google.firebase.firestore.core.Target decodeQueryTarget(com.google.firestore.v1.Target.QueryTarget r24) {
        /*
            r23 = this;
            r0 = r23
    ...
    private Filter decodeUnaryFilter(StructuredQuery.UnaryFilter proto) {
        ...
        int i = AnonymousClass1.$SwitchMap$com$google$firestore$v1$StructuredQuery$UnaryFilter$Operator[proto.getOp().ordinal()];
        if (i == 1) {
    ...
    private OrderBy decodeOrderBy(StructuredQuery.Order proto) {
        ...
        FieldPath fieldPath = FieldPath.fromServerFormat(proto.getField().getFieldPath());
        int i = AnonymousClass1.$SwitchMap$com$google$firestore$v1$StructuredQuery$Direction[proto.getDirection().ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                $SwitchMap$com$google$firestore$v1$StructuredQuery$FieldFilter$Operator[StructuredQuery.FieldFilter.Operator.IN.ordinal()] = 7;
            } catch (NoSuchFieldError e21) {
            }
            try {
                $SwitchMap$com$google$firestore$v1$StructuredQuery$FieldFilter$Operator[StructuredQuery.FieldFilter.Operator.ARRAY_CONTAINS_ANY.ordinal()] = 8;
    ...
    public WatchChange decodeWatchChange(ListenResponse protoChange) {
        ...
        int i = AnonymousClass1.$SwitchMap$com$google$firestore$v1$ListenResponse$ResponseTypeCase[protoChange.getResponseTypeCase().ordinal()];
        if (i == 1) {
