...
public class View {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:57:0x0122, code lost:
        if (r0.query.comparator().compare(r15, r10) <= 0) goto L_0x0127;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:61:0x0133, code lost:
        if (r0.query.comparator().compare(r15, r11) < 0) goto L_0x0135;
     */
    ...
    private static int changeTypeOrder(DocumentViewChange change) {
        int i = AnonymousClass1.$SwitchMap$com$google$firebase$firestore$core$DocumentViewChange$Type[change.getType().ordinal()];
        if (i == 1) {
            return 1;
        }
        if (i == 2 || i == 3) {
