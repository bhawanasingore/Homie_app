...
public class UserData {
    ...
    public static class ParseContext {
        ...
        /* synthetic */ ParseContext(ParseAccumulator x0, FieldPath x1, boolean x2, AnonymousClass1 x3) {
            this(x0, x1, x2);
        }
    ...
    public static class ParsedSetData {
        ...
        public List<Mutation> toMutationList(DocumentKey key, Precondition precondition) {
            ...
            if (fieldMask2 != null) {
                mutations.add(new PatchMutation(key, this.data, fieldMask2, precondition));
            } else {
