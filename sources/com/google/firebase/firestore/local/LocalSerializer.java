...
public final class LocalSerializer {
    ...
    public com.google.firebase.firestore.model.MaybeDocument decodeMaybeDocument(MaybeDocument proto) {
        int i = AnonymousClass1.$SwitchMap$com$google$firebase$firestore$proto$MaybeDocument$DocumentTypeCase[proto.getDocumentTypeCase().ordinal()];
        if (i == 1) {
    ...
    private com.google.firebase.firestore.model.Document decodeDocument(com.google.firestore.v1.Document document, boolean hasCommittedMutations) {
    ...
    public TargetData decodeTargetData(Target targetProto) {
        ...
        int i = AnonymousClass1.$SwitchMap$com$google$firebase$firestore$proto$Target$TargetTypeCase[targetProto.getTargetTypeCase().ordinal()];
        if (i == 1) {
