...
public final class SQLitePersistence extends Persistence {
    ...
    static class Query {
        ...
        public int forEach(com.google.firebase.firestore.util.Consumer<android.database.Cursor> r5) {
            /*
                r4 = this;
                r0 = 0
                android.database.Cursor r1 = r4.startQuery()
            L_0x0005:
                boolean r2 = r1.moveToNext()     // Catch:{ all -> 0x0017 }
                if (r2 == 0) goto L_0x0011
                int r0 = r0 + 1
                r5.accept(r1)     // Catch:{ all -> 0x0017 }
                goto L_0x0005
            L_0x0011:
            ...
            L_0x0021:
                throw r2
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.firestore.local.SQLitePersistence.Query.forEach(com.google.firebase.firestore.util.Consumer):int");
        }
