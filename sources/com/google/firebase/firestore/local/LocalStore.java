...
public final class LocalStore {
    ...
    public LocalStore(Persistence persistence2, QueryEngine queryEngine2, User initialUser) {
        ...
        RemoteDocumentCache remoteDocumentCache = persistence2.getRemoteDocumentCache();
        this.remoteDocuments = remoteDocumentCache;
        LocalDocumentsView localDocumentsView = new LocalDocumentsView(remoteDocumentCache, this.mutationQueue, persistence2.getIndexManager());
