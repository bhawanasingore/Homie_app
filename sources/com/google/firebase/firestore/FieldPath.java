...
public final class FieldPath {
    ...
    public static FieldPath of(String... fieldNames) {
        ...
        for (int i = 0; i < fieldNames.length; i++) {
            boolean z = fieldNames[i] != null && !fieldNames[i].isEmpty();
            Preconditions.checkArgument(z, "Invalid field name at argument " + (i + 1) + ". Field names must not be null or empty.", new Object[0]);
        }
