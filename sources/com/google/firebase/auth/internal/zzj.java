...
public final class zzj extends AbstractSafeParcelable implements UserInfo {
    ...
    public final String zzb() {
        ...
        try {
            ...
            jSONObject.putOpt(Constants.DISPLAY_NAME, this.zzc);
            jSONObject.putOpt("photoUrl", this.zzd);
            jSONObject.putOpt("email", this.zzf);
            jSONObject.putOpt(Constants.PHONE_NUMBER, this.zzg);
    ...
    public static zzj zza(String str) {
        try {
            ...
            return new zzj(jSONObject.optString("userId"), jSONObject.optString(Constants.PROVIDER_ID), jSONObject.optString("email"), jSONObject.optString(Constants.PHONE_NUMBER), jSONObject.optString(Constants.DISPLAY_NAME), jSONObject.optString("photoUrl"), jSONObject.optBoolean("isEmailVerified"), jSONObject.optString("rawUserInfo"));
        } catch (JSONException e) {
