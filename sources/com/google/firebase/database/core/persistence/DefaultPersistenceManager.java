...
public class DefaultPersistenceManager implements PersistenceManager {
    ...
    public void setTrackedQueryKeys(QuerySpec query, Set<ChildKey> keys) {
        this.storageLayer.saveTrackedQueryKeys(this.trackedQueryManager.findTrackedQuery(query).id, keys);
    }

    public void updateTrackedQueryKeys(QuerySpec query, Set<ChildKey> added, Set<ChildKey> removed) {
        this.storageLayer.updateTrackedQueryKeys(this.trackedQueryManager.findTrackedQuery(query).id, added, removed);
    }
