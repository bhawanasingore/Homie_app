...
final /* synthetic */ class zzag implements Runnable {
    ...
    public final void run() {
        ...
        L_0x0002:
            monitor-enter(r0)
            int r1 = r0.zza     // Catch:{ all -> 0x00b1 }
            r2 = 2
            if (r1 == r2) goto L_0x000a
            monitor-exit(r0)     // Catch:{ all -> 0x00b1 }
            return
        L_0x000a:
            java.util.Queue<com.google.firebase.iid.zzan<?>> r1 = r0.zzd     // Catch:{ all -> 0x00b1 }
            boolean r1 = r1.isEmpty()     // Catch:{ all -> 0x00b1 }
            if (r1 == 0) goto L_0x0017
            r0.zzb()     // Catch:{ all -> 0x00b1 }
            monitor-exit(r0)     // Catch:{ all -> 0x00b1 }
            return
        L_0x0017:
            java.util.Queue<com.google.firebase.iid.zzan<?>> r1 = r0.zzd     // Catch:{ all -> 0x00b1 }
            java.lang.Object r1 = r1.poll()     // Catch:{ all -> 0x00b1 }
            com.google.firebase.iid.zzan r1 = (com.google.firebase.iid.zzan) r1     // Catch:{ all -> 0x00b1 }
            android.util.SparseArray<com.google.firebase.iid.zzan<?>> r3 = r0.zze     // Catch:{ all -> 0x00b1 }
            int r4 = r1.zza     // Catch:{ all -> 0x00b1 }
            r3.put(r4, r1)     // Catch:{ all -> 0x00b1 }
            com.google.firebase.iid.zzab r3 = r0.zzf     // Catch:{ all -> 0x00b1 }
            java.util.concurrent.ScheduledExecutorService r3 = r3.zzc     // Catch:{ all -> 0x00b1 }
            com.google.firebase.iid.zzai r4 = new com.google.firebase.iid.zzai     // Catch:{ all -> 0x00b1 }
        ...
        L_0x0067:
            ...
            r4.putBundle(r3, r1)
            r5.setData(r4)
            com.google.firebase.iid.zzal r1 = r0.zzc     // Catch:{ RemoteException -> 0x00a7 }
            r1.zza(r5)     // Catch:{ RemoteException -> 0x00a7 }
            goto L_0x0002
        L_0x00a7:
            r1 = move-exception
