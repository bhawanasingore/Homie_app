...
public abstract class AbstractFuture<V> extends FluentFuture<V> {
    ...
    public V get(long timeout, TimeUnit unit) throws InterruptedException, TimeoutException, ExecutionException {
        long j = timeout;
        long remainingNanos = unit.toNanos(j);
        if (!Thread.interrupted()) {
            ...
            if (isDone()) {
                throw new TimeoutException("Waited " + j + " " + unit.toString().toLowerCase(Locale.ROOT) + " but future completed as timeout expired");
            }
            throw new TimeoutException("Waited " + j + " " + unit.toString().toLowerCase(Locale.ROOT) + " for " + futureToString);
        }
        throw new InterruptedException();
    }
    ...
    public boolean cancel(boolean r11) {
        ...
        L_0x0036:
            ...
            boolean r7 = r6 instanceof com.google.common.util.concurrent.AbstractFuture.TrustedFuture
