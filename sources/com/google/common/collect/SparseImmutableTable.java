...
final class SparseImmutableTable<R, C, V> extends RegularImmutableTable<R, C, V> {
    ...
    SparseImmutableTable(ImmutableList<Table.Cell<R, C, V>> cellList, ImmutableSet<R> rowSpace, ImmutableSet<C> columnSpace) {
        ...
        while (i < cellList.size()) {
            ...
            cellRowIndices2[i] = indexMap.get(rowKey).intValue();
            ...
            if (oldValue == null) {
                ...
                ImmutableMap<R, Integer> immutableMap = indexMap;
        ...
        ImmutableMap<R, Integer> immutableMap2 = indexMap;
    ...
    public ImmutableTable.SerializedForm createSerializedForm() {
        ...
        while (it.hasNext()) {
            cellColumnIndices[i] = columnKeyToIndex.get(((Table.Cell) it.next()).getColumnKey()).intValue();
            i++;
        }
