...
public final class StringValue extends GeneratedMessageLite<StringValue, Builder> implements StringValueOrBuilder {
    ...
    public int getSerializedSize() {
        ...
        int size2 = 0;
        if (!this.value_.isEmpty()) {
            size2 = 0 + CodedOutputStream.computeStringSize(1, getValue());
        }
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke method, Object arg0, Object arg1) {
        switch (AnonymousClass1.$SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke[method.ordinal()]) {
            ...
            case 5:
                StringValue other = (StringValue) arg1;
                this.value_ = ((GeneratedMessageLite.Visitor) arg0).visitString(!this.value_.isEmpty(), this.value_, !other.value_.isEmpty(), other.value_);
