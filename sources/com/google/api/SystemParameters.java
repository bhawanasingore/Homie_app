...
public final class SystemParameters extends GeneratedMessageLite<SystemParameters, Builder> implements SystemParametersOrBuilder {
    ...
    /* access modifiers changed from: private */
    public void setRules(int index, SystemParameterRule.Builder builderForValue) {
        ensureRulesIsMutable();
        this.rules_.set(index, (SystemParameterRule) builderForValue.build());
    }
    ...
    /* access modifiers changed from: private */
    public void addRules(SystemParameterRule.Builder builderForValue) {
        ensureRulesIsMutable();
        this.rules_.add((SystemParameterRule) builderForValue.build());
    }

    /* access modifiers changed from: private */
    public void addRules(int index, SystemParameterRule.Builder builderForValue) {
        ensureRulesIsMutable();
        this.rules_.add(index, (SystemParameterRule) builderForValue.build());
    }
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<SystemParameters, Builder> implements SystemParametersOrBuilder {
        ...
        public Builder setRules(int index, SystemParameterRule.Builder builderForValue) {
            copyOnWrite();
            ((SystemParameters) this.instance).setRules(index, builderForValue);
            return this;
        }
        ...
        public Builder addRules(SystemParameterRule.Builder builderForValue) {
            copyOnWrite();
            ((SystemParameters) this.instance).addRules(builderForValue);
            return this;
        }

        public Builder addRules(int index, SystemParameterRule.Builder builderForValue) {
            copyOnWrite();
            ((SystemParameters) this.instance).addRules(index, builderForValue);
            return this;
        }
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke method, Object arg0, Object arg1) {
        switch (AnonymousClass1.$SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke[method.ordinal()]) {
            ...
            case 5:
                this.rules_ = ((GeneratedMessageLite.Visitor) arg0).visitList(this.rules_, ((SystemParameters) arg1).rules_);
                ...
                while (!done) {
                    try {
                        ...
                        if (tag == 0) {
                            ...
                            this.rules_.add((SystemParameterRule) input.readMessage(SystemParameterRule.parser(), extensionRegistry));
    ...
    static {
        ...
        systemParameters.makeImmutable();
    }
