...
public final class Control extends GeneratedMessageLite<Control, Builder> implements ControlOrBuilder {
    ...
    public int getSerializedSize() {
        ...
        int size2 = 0;
        if (!this.environment_.isEmpty()) {
            size2 = 0 + CodedOutputStream.computeStringSize(1, getEnvironment());
        }
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke method, Object arg0, Object arg1) {
        switch (AnonymousClass1.$SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke[method.ordinal()]) {
            ...
            case 5:
                Control other = (Control) arg1;
                this.environment_ = ((GeneratedMessageLite.Visitor) arg0).visitString(!this.environment_.isEmpty(), this.environment_, !other.environment_.isEmpty(), other.environment_);
                ...
                while (!done) {
                    try {
                        ...
                        if (tag == 0) {
                            ...
                            this.environment_ = input.readStringRequireUtf8();
